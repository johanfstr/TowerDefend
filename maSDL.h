...
cls(ecran, 0); // remplit ecran de noir ( = efface l'�cran).

Hline(ecran, 10, 10, 50, color); // ligne horizontale de 50 pxl commen�ant en 10, 10 de couleur color.

Vline(ecran, 10, 10, 50, color); // ligne verticale de 50 pxl commen�ant en 10, 10 de couleur color.

Cpxl(ecran, 10, 16, color); // verifie que les coordonn�es sont dans ecran avant d'appeler pxl(ecran, 10, 16, color) ( = clipping).

box(ecran, 10, 10, 50, 20, color); // rectangle vide de couleur color en 10, 10 de dimensions 50, 20.

line(ecran, 0, 0, 10, 10, 0xFF0000); ligne  rouge entredeux pts de coordonn�es (0, 0) et (10, 10) inclus.
